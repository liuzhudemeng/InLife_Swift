...
//获取图片的exif 信息
+ (NSDictionary*)exifDictionary:(NSURL*)imageUrl
{
    CGImageSourceRef imageRef = CGImageSourceCreateWithURL((CFURLRef)imageUrl, NULL);
    CGImageSourceRef imageSource = CGImageSourceCreateWithURL((CFURLRef)imageRef, NULL);
   ...
   // NSDictionary     *imageProperty = (NSDictionary*)CGImageSourceCopyPropertiesAtIndex(imageRef, 0, NULL);
    return exifDic;
}
